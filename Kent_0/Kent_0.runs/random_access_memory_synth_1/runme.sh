...
HD_PWD='C:/Users/seanj/Documents/Kent_0/Kent_0/Kent_0/Kent_0.runs/random_access_memory_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log random_access_memory.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source random_access_memory.tcl

...
#
# Generated by export_simulation on Sat Oct 23 15:24:51 -0400 2021
#
################################################################################
...
'-reset_run' switch to the './program_memory.sh' script.

./program_memory.sh -reset_run
...
./program_memory.sh -noclean_files

For more information on the script, please type './program_memory.sh -help'.
